...
typedef SuggestionBuilder<T> = Widget Function(T t);
...
class SearchPage<T> extends SearchDelegate<T> {
  ...
  final SuggestionBuilder<T> suggestion;
  ...
  SearchPage({
    ...
    this.suggestionIndex = const SizedBox(),
  ...
  Widget buildSuggestions(BuildContext context) {
    ...
    return cleanQuery.isEmpty && !showItemsOnEmpty
        ? ListView(
            children: [suggestionIndex, ...result.map(suggestion).toList()])
        : result.isEmpty
            ? failure
